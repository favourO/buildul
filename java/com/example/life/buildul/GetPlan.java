...
public class GetPlan extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mAuth.getCurrentUser() == null){
            ...
            startActivity(new Intent(GetPlan.this, Login.class));
            finish();
        }else {
    ...
    public void onClick(View view) {
        ...
        progressDialog = new ProgressDialog(GetPlan.this);
        ...
        complete = (EditText) findViewById(R.id.feedback_message);
    ...
    private void Fedback(String name, String email, String feedback) {
        ...
        progressDialog.dismiss();
        AlertDialog.Builder alert = new AlertDialog.Builder(GetPlan.this);
        alert.setTitle("Alert")
                ...
                .setPositiveButton("Continue", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent i = new Intent(GetPlan.this, MainActivity.class);
                        startActivity(i);
                    }
                });
        alert.show();
